        ...
        <View style={{flex: 1, backgroundColor:'#7d807d', flexDirection:'column', justifyContent:'flex-end',}}>
            ...
            <View style={{backgroundColor:'white', height:'80%', paddingVertical:10, paddingHorizontal:15, borderTopLeftRadius: 15, borderTopRightRadius: 15,}}>
                <View style={{display: 'flex', flexDirection: 'row'}}>
                    <View style={{position: 'absolute', top: -50, width: 80, height: 80,justifyContent: 'center',alignItems: 'center',backgroundColor: 'white', borderRadius: 50, borderWidth: 4, borderColor: 'black'}}>
                       <FontAwesome name="trash" size={50} color="black"
                            style={{}}
                        /> 
                    </View>
                    <Text style={{marginLeft:90,marginRight:'auto', fontSize:20, fontWeight: 'bold', marginBottom: 30, paddingRight: 50,marginTop:0}} >Cocunut Shell</Text> 
                </View>
                
                <View style={{ borderRadius: 15, alignItems: 'center', justifyContent: 'center', paddingVertical: 5, marginBottom: 15}}>
                    <Text style={{fontSize: 15 , fontWeight: 'bold'}}>Don't throw as waste try to</Text>
                    <Text style={{fontSize: 15 , fontWeight: 'bold'}}>create amazing creatures</Text>
                </View>
